 ...
 *
   * #undef first so the generated define above can stay exactly where CubeMX

 ** puts it. Regeneration then has nothing to restore and cannot leave a
   * duplicate whose winner depends on file order - DEV-1017. */
