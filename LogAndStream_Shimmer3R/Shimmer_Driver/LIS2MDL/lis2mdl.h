...
#define LIS2MDL_SPI_4WIRES_BUS \
  1U /* NOTE: if you use the component in SPI 4-Wires mode, you lose the DRDY pin */
#define LIS2MDL_SPI_3WIRES_BUS 2U
#define LSM6DSOX_SENSORHUB_LIS2MDL_I2C_BUS \
  3U /* LSM6DSOX SensorHub with LIS2MDL example */

#define LIS2MDL_MAG_SENSITIVITY_FS_50GAUSS \
  1.500f /**< Sensitivity value for 50 gauss full scale [mgauss/LSB] */
