...
uint8_t adxl371_self_test(void)
{
  ...
  ret = adxl371_reset(&adxl371_dev);

  /*2. Place the device in measurement mode. */
  ret = adxl371_set_bandwidth(&adxl371_dev, ADXL371_BW_320HZ);
  ret = adxl371_set_odr(&adxl371_dev, ADXL371_ODR_320HZ);
  ret = adxl371_set_op_mode(&adxl371_dev, ADXL371_FULL_BW_MEASUREMENT);
...
//  platform_write(&adxl371_dev, ADXL371_SELF_TEST, ADXL371_ST);
  ...
  while(1)
  {
    ...
    ret = platform_read(&adxl371_dev, ADXL371_SELF_TEST, &self_test_reg);
