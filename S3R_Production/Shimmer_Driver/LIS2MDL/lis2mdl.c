...
static int32_t LSM6DSOX_SENSORHUB_LIS2MDL_ReadShData(LIS2MDL_Object_t *pObj,
    ...
    uint8_t *pData,
    uint16_t Length);
static int32_t LSM6DSOX_SENSORHUB_LIS2MDL_WriteShData(LIS2MDL_Object_t *pObj,
    uint8_t Reg,
    uint8_t *pData,
    uint16_t Length);
...
int32_t LIS2MDL_Init(LIS2MDL_Object_t *pObj)
{
  ...
  if (pObj->IO.BusType == LSM6DSOX_SENSORHUB_LIS2MDL_I2C_BUS) /* LSM6DSOX SensorHub with LIS2MDL example */
  {
    ...
    if (LSM6DSOX_SENSORHUB_LIS2MDL_ReadShData(pObj, LIS2MDL_CFG_REG_C, (uint8_t *) &reg_c, 1)
        != LIS2MDL_OK)
    {
      return LIS2MDL_ERROR;
    }
    if (LSM6DSOX_SENSORHUB_LIS2MDL_ReadShData(pObj, LIS2MDL_CFG_REG_A, (uint8_t *) &reg_a, 1)
        != LIS2MDL_OK)
    {
      return LIS2MDL_ERROR;
    }
    ...
    if (LSM6DSOX_SENSORHUB_LIS2MDL_WriteShData(pObj, LIS2MDL_CFG_REG_C, (uint8_t *) &reg_c, 1)
        != LIS2MDL_OK)
    {
      return LIS2MDL_ERROR;
    }
    if (LSM6DSOX_SENSORHUB_LIS2MDL_WriteShData(pObj, LIS2MDL_CFG_REG_A, (uint8_t *) &reg_a, 1)
        != LIS2MDL_OK)
    {
      return LIS2MDL_ERROR;
    }
...
int32_t LIS2MDL_MAG_Get_DRDY_Status(LIS2MDL_Object_t *pObj, uint8_t *Status)
{
  ...
  if (pObj->IO.BusType == LSM6DSOX_SENSORHUB_LIS2MDL_I2C_BUS) /* LSM6DSOX SensorHub with LIS2MDL example */
  {
    if (LSM6DSOX_SENSORHUB_LIS2MDL_ReadShData(pObj, LIS2MDL_STATUS_REG, (uint8_t *) &reg, 1)
        != LIS2MDL_OK)
    {
      return LIS2MDL_ERROR;
    }
