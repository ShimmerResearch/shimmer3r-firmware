...
#define GPIO_ADC_EXT_EXP1_Pin GPIO_PIN_5
#define GPIO_ADC_EXT_EXP1_GPIO_Port GPIOA
#define GPIO_ADC_EXT_EXP2_Pin GPIO_PIN_6
...
#define ICM_INT1_Pin GPIO_PIN_11
#define ICM_INT1_GPIO_Port GPIOE
#define SW_I2C2_Pin GPIO_PIN_12
...
#define CS_BMP_Pin GPIO_PIN_6
#define CS_BMP_GPIO_Port GPIOD
#define CS_LSM_Pin GPIO_PIN_7
#define CS_LSM_GPIO_Port GPIOD
#define SW_EXP_BRD_Pin GPIO_PIN_5
#define SW_EXP_BRD_GPIO_Port GPIOB
#define CS_ICM_Pin GPIO_PIN_6
#define CS_ICM_GPIO_Port GPIOB
#define LED_UPR_RD_Pin GPIO_PIN_7
#define LED_UPR_RD_GPIO_Port GPIOB
