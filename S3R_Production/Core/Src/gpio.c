...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOD,
      CS_BMP390_Pin | CS_LIS2DW12_Pin | BT_RST_Pin | BT_LP_MODE_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, SW_GSR_Pin | SW_SENSE_IO_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(CS_HIGH_G_GPIO_Port, CS_HIGH_G_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SW_MIC_GPIO_Port, SW_MIC_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, SW_BT_Pin | SW_SD_MCU_DOCK_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PDPin PDPin PDPin PDPin
                           PDPin PDPin */
  GPIO_InitStruct.Pin = CS_BMP390_Pin | SW_FLASH_Pin | SW_SENSE_Pin
      | CS_LIS2DW12_Pin | BT_RST_Pin | BT_LP_MODE_Pin;
  ...
  GPIO_InitStruct.Pin = SW_BT_Pin | CS_LSM6DSV_Pin | BT_CP_ROLE_Pin | SW_SD_MCU_DOCK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
