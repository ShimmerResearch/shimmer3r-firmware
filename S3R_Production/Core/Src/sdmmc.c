...
void printSdCardInfo(void)
{
  ...
  printf(", Size=%.2lfGB", (hsd1.SdCard.BlockSize * ((float)hsd1.SdCard.BlockNbr/1024/1024/1024)));
  printf(", Manufacture Date=%d-%02d", (pCID.ManufactDate/10)+1990, pCID.ManufactDate%10);
