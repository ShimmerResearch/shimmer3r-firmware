...
/* Defined, it enables device HID zero copy and flexible queue support (works if
   ...
   invalid (are 0s or exceed upper mentioned definition), UX_DEVICE_CLASS_HID_MAX_EVENTS_QUEUE
   and UX_DEVICE_CLASS_HID_EVENT_BUFFER_LENGTH are used to calculate and
   allocate the queue.  */
